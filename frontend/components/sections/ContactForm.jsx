 ...
 * - Registers affiliate with Hooplaseft iREV system
...
const ContactFormContent = ({ searchParams }) => {
  ...
  const [apiStatus, setApiStatus] = useState(null); // 'posted' | 'error' | null
  ...
  const [ftdStatus, setFtdStatus] = useState(null); // 'success' | 'error' | null
